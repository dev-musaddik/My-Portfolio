    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            <div className="p-8 rounded-lg shadow-lg w-full max-w-md bg-white dark:bg-black">
                <h1 className="text-3xl font-bold text-center mb-6 text-black dark:text-white">Sign Up</h1>
                ...
                <p className="mt-6 text-center text-gray-600 dark:text-gray-400">
                    Already have an account? <Link to="/login" className="text-black dark:text-white hover:underline">Sign In</Link>
                </p>
            </div>
        </div>
    );
